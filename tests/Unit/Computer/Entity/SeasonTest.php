...
class SeasonTest extends TestCase
{
    ...
    public function it_checks_if_driver_podiums_can_be_calculated(): void
    {
        ...
        // and given
        $track1 = Track::create('Britain', 'Silverstone', 'silverstone.png', '52.071', '-1.016');
        $track2 = Track::create('Hungary', 'Hungaroring', 'hungary.png', '47.582222', '19.251111');
        $track3 = Track::create('Spain', 'Spain', 'spain.png', '40.465278', '-3.615278');
        $track4 = Track::create('Usa', 'Usa', 'usa.png', '30.132778', '-97.641111');
        $track5 = Track::create('Belgium', 'Belgium', 'belgium.png', '50.437222', '5.971389');

 ...
 */
final class Version20200327185700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE qualification ADD driver_id INT NOT NULL, ADD race_id INT NOT NULL, DROP driver, DROP race');
        ...
        $this->addSql('CREATE INDEX IDX_B712F0CE6E59D40D ON qualification (race_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B712F0CE6E59D40D ON qualification');
        $this->addSql('ALTER TABLE qualification ADD driver SMALLINT NOT NULL, ADD race SMALLINT NOT NULL, DROP driver_id, DROP race_id');
        $this->addSql('ALTER TABLE season CHANGE team_id team_id INT DEFAULT NULL');
